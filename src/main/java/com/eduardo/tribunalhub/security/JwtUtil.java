...
public class JwtUtil {
    ...
    @Value("${jwt.secret:tribunalhub-secret-key-very-long-and-secure-for-jwt-token-generation}")
    ...
    public String generateToken(String username, String tipoUsuario, Long userId) {
        Map<String, Object> claims = new HashMap<>();
